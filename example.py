...
def run(model_id, record_id, subsample_start=0, posthresh=0.2, cmap_adjust=0.3, fltr=True, last_conv_layer_name='activation_4', model_dir='./models/', plot_dir='./examples/', filetype='png'):
    # Generate plot dir
